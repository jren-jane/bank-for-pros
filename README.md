...
To run the application locally, you need to have JDK 8 and Tomcat 9.0.41 installed on your machine. And you need the servlet and JSTL libruaries stated in the POM file put in your Tomcat home. 
